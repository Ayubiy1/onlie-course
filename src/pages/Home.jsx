            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {stats.map((stat, index) => (
                    <Card key={index} className="text-white" style={{ backgroundColor: "transparent" }}>
                        <div className={`p-a2 h-full lg: p-4 rounded shadow ${stat.bg} flex flex-wrap items-center lg:justify-between`}>
                            <div className="text-center">
                                <p className="lg:text-lg font-semibold">{stat.title}</p>
